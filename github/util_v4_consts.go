...
const (
	...
	PROTECTION_REQUIRES_MERGE_QUEUE                 = "require_merge_queue"
	PROTECTION_MERGE_METHOD                         = "merge_method"
	PROTECTION_BUILD_CONCURRENCY                    = "build_concurrency"
	PROTECTION_MERGE_LIMIT_MIN_NUMBER               = "merge_limit_min_number"
	PROTECTION_MERGE_LIMIT_MIN_TIME                 = "merge_limit_min_time"
	PROTECTION_MERGE_LIMIT_MAX_NUMBER               = "merge_limit_max_number"
	PROTECTION_MERGE_ONLY_NON_FAILING_PULL_REQUESTS = "merge_only_non_failing_pull_requests"
	PROTECTION_STATUS_CHECK_TIMEOUT                 = "status_check_timeout"
